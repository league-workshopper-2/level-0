...
if (mouseColor ==-8851345) {
	MyRobot.mouseMove(720,93);
}
		// 10. if the mouse is on the end color
		if (mouseColor == -16711423) {
			JOptionPane.showMessageDialog(null, "You Won... This Time");
		}
